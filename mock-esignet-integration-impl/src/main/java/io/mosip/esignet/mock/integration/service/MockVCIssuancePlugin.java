...
import io.mosip.esignet.mock.integration.mdoc.MdocMdLBuilder;
...
public class MockVCIssuancePlugin implements VCIssuancePlugin {
	...
	public VCResult<String> getMDocVerifiableCredential(MdocRequestDto mdocRequestDto, String holderId, Map<String, Object> identityDetails) throws VCIExchangeException {
        ...
        try {
            vcResult.setCredential(getEncodedMdocData());
	...
	public String getEncodedMdocData() throws JsonProcessingException {
		MDocBuilder mDocBuilder = new MdocMdLBuilder().buildMockMDoc();
		ObjectMapper mapper = new ObjectMapper(new CBORFactory());
		byte[] cborBytes = mapper.writeValueAsBytes(mDocBuilder);

		// Encode to Base64 string
		String base64String = Base64.getEncoder().encodeToString(cborBytes);
		return base64String;
	}
